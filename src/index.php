...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    ...
    <!-- SIGN UP -->
    <div class="container bg-white shadow-lg rounded-lg p-8" id="signup" style="display:none;">
        ...
        <p class="or text-center text-gray-500 mt-6">
            ----------or----------
        </p>
        <div class="icons flex justify-center space-x-4 mt-4">
    ...
    <!-- SIGN IN -->
    <div class="container bg-white shadow-lg rounded-lg p-8" id="signIn">
